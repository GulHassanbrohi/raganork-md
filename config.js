...
module.exports = {
    ...
    ANTI_SPAM: process.env.ANTI_SPAM || '+923173498817-1632403322@g.us',
    ...
    RG: process.env.RG || '+923173498817-1632403322@g.us,120363116963909366@g.us',
    BOT_INFO: process.env.BOT_INFO || 'Hassan;Skl11;0;https://i.imgur.com/P7ziVhr.jpeg;https://chat.whatsapp.com/Dt3C4wrQmt0GG6io1IBIHb',
    ...
    BOT_NAME: process.env.BOT_NAME || 'Habibi',
